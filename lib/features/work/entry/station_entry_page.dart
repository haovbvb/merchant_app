...
class StationEntryPage extends StatefulWidget {
  const StationEntryPage({super.key});

  @override
  State<StationEntryPage> createState() => _StationEntryPageState();
}

class _StationEntryPageState extends State<StationEntryPage> {
  ...
  Future<_StationItem?> _showItemDialog({_StationItem? initial}) async {
    final l10n = context.l10n;
            ...
            ElevatedButton(
              onPressed: () => Navigator.of(context).pop(
                _StationItem(
                  ...
                  lockDevId: lockController.text.trim(),
                ),
              ),
