...
//        Rect previewFrame = previewFramingRect;
        ...
        paint.setColor(0xFFFB6800);//定义画笔的颜色
        ...
        if (resultBitmap != null) {
            ...
            // 防护：避免 /0
            int previewW = previewFrame.width;
            int previewH = previewFrame.height;
            float scaleX = 1f;
            float scaleY = 1f;
            if (previewW == 0 || previewH == 0) {
                // 兜底，避免 Crash
                 ...
                 scaleX = frame.width() / (float) previewW;
                 scaleY = frame.height() / (float) previewH;
                // 使用 scaleX, scaleY ...
            }
