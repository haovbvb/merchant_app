...
import com.okla.ops.utils.ColorUtils;


/**
 * SwitchButton
 *
 * @author kyleduo com.mcxt.basic.dialog.picker.SwitchButton
 * @since 2014-09-24
 */
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mTintColor == 0) {
            ...
            boolean found = getContext().getTheme().resolveAttribute(com.google.android.material.R.attr.colorAccent, typedValue, true);
            if (found) {
