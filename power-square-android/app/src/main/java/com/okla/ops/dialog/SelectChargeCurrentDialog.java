 ...
 * Version:
 */
public class SelectChargeCurrentDialog extends BasePopupWindow {
    private SingleDataBindingNoPUseAdapter mAdapter;
    private OnSelectClickListener selectClickListener;

    public SelectChargeCurrentDialog(Context context, final List<CurrentPointBean> data) {
        super(context);
        ...
        mAdapter = new SingleDataBindingNoPUseAdapter<CurrentPointBean>(R.layout.item_select_charge_current){
            @Override
    ...
    public SelectChargeCurrentDialog setOnSelectClickListener(OnSelectClickListener listener) {
        selectClickListener = listener;
        return this;
    }

//    public interface OnSelectClickListener {
//        void onItemClick(CurrentAndPointBean.ElectricsBean data);
//    }
    public interface OnSelectClickListener {
