...
import com.okla.ops.databinding.ActivityBluetoothAuthorizationBinding;
...
public class BluetoothAuthorizationActivity extends BaseNormalListVActivity<BluetoothAuthorizationViewModel, ActivityBluetoothAuthorizationBinding> implements View.OnClickListener {
    ...
    public static Intent getIntents(Context context) {
        Intent intent = new Intent(context, BluetoothAuthorizationActivity.class);
        return intent;
    }
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mSingleDataBindingNoPUseAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            if (!BleManager.getInstance().isConnected(bleDevice)) {
                ...
                BluetoothOperateActivity.startBluetoothOperateActivity(mContext, bleDevice, null, -1);
            }
        ...
        mBinding.sbBluetoothState.setOnCheckedChangeListener((buttonView, isChecked) -> {
            mBinding.tvBluetoothSwitchDesc.setText(isChecked ? getString(R.string.bluetooth_authorization_switch_open)
                    : getString(R.string.bluetooth_authorization_switch_close));
            if (isChecked) {
        ...
        mBinding.tvBluetoothSwitchDesc.setText(mBinding.sbBluetoothState.isChecked() ? getString(R.string.bluetooth_authorization_switch_open)
                : getString(R.string.bluetooth_authorization_switch_close));
        onRefresh();
        checkPermissions();
    }
...
//                }
                BluetoothOperateActivity.startBluetoothOperateActivity(mContext, bleDevice, gatt, status);
