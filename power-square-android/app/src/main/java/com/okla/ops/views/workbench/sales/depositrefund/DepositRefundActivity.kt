...
class DepositRefundActivity :
    BaseNormalVActivity<DepositRefundViewModel, ActivityRentbindBinding>() {

    companion object {
        fun startActivity(context: Context) {
            val intent = Intent(context, DepositRefundActivity::class.java)
    ...
    override fun getLayoutId(): Int {
        return R.layout.activity_depositrefound
    }
