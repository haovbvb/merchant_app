...
class RentBindActivity: BaseNormalVActivity<RentBindViewModel, ActivityRentbindBinding>() {

    companion object {
        fun startActivity(context: Context) {
            val intent = Intent(context, RentBindActivity::class.java)
            context.startActivity(intent)
        }
    }

    override fun onCreateViewModel(): RentBindViewModel {
        return ViewModelProvider(this)[RentBindViewModel::class.java]
    }

    override fun getLayoutId(): Int {
        return R.layout.activity_rentbind
    }
