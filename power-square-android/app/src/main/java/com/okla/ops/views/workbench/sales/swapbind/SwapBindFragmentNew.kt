        ...
        when (v?.id) {
                                ...
                                object : DialogSelectSwapBindVehicle.SelectCallBack {
                                    override fun onSelectedCar(car: CarVo) {
                                        if (car != null) {
                                            ...
                                            Glide.with(this@SwapBindFragmentNew).load(car.img)
                                                .into(imgCar)
                                            if (car.bindSource == 1) {
            ...
            R.id.btnConfirm -> {
                ...
                PaymentMethodDialogFragment.getInstance(
                    ...
                    .show(this@SwapBindFragmentNew.childFragmentManager, "payment_method_dialog")
        ...
        batteryAdapter =
            object :
                ...
                override fun convert(helper: BaseViewHolder, item: BatteryVo?) {
                    ...
                    tvSn.text = "SN:".plus(item?.sn)
                    context?.let { Glide.with(it).load(item?.img).into(ivBattery) }
                    tvModel.text = item?.model.plus(" • ").plus(item?.spec)
    ...
    private fun askPermission() {
        ...
        permissionManager.checkPermissions(object : PermissionListenerImpl() {
            override fun passPermission() {
                ...
                IntentIntegrator.forSupportFragment(this@SwapBindFragmentNew)
