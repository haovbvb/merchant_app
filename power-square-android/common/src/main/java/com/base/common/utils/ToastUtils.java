...
public class ToastUtils {
    ...
    private static Drawable sLeftDrawable;
    ...
    /**
     * Set the left drawable of message
     *
     * @param drawable The left drawable of message
     */
    public static void setMsgLeftDrawable(final Drawable drawable) {
        sLeftDrawable = drawable;
    }
     ...
     */
    public static android.view.View showCustomShort(@LayoutRes final int layoutId) {
        final android.view.View view = getView(layoutId);
     ...
     * @param layoutId ID for an XML layout resource to load.
     */
    public static android.view.View showCustomLong(@LayoutRes final int layoutId) {
        final android.view.View view = getView(layoutId);
...
//                }
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
                    final android.widget.TextView tvMessage = sToast.getView().findViewById(android.R.id.message);
                    ...
                    if (sLeftDrawable != null) {
                        tvMessage.setCompoundDrawablesWithIntrinsicBounds(sLeftDrawable, null, null, null);
                    }
    ...
    private static void setBg() {
        if (sBgResource != -1) {
            final android.view.View toastView = sToast.getView();
    ...
    private static android.view.View getView(@LayoutRes final int layoutId) {
    ...
    static class ToastFactory {
        ...
        static IToast makeToast(Context context, CharSequence text, int duration) {
            ...
            android.util.Log.e("ToastUtils", "Toast is GG. In fact, next step is useless.");
            return new SystemToast(makeNormalToast(context, text, duration));
        }
    ...
    static class SystemToast implements IToast {
        ...
        SystemToast(@androidx.annotation.NonNull Toast toast) {
            mToast = toast;
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
                try {
    ...
    static class ToastWithoutNotification implements IToast {
        ...
        ToastWithoutNotification(@androidx.annotation.NonNull Toast toast) {
            mToast = toast;
