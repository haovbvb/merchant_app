 ...
 * @Version:
 */
public abstract class BaseListMvpFragment<P extends BasePresenter, V extends ViewDataBinding>
        extends BaseMvpFragment<P, V>
        implements ItemsBaseView, RefreshLoadMoreListener, StateViewClickListener {
