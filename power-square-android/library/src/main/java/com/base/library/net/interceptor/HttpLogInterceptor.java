...
//            Logger.i(message);
    ...
    public Response intercept(@NonNull Chain chain) throws IOException {
        Logger.e("MyInterceptor HttpLogInterceptor " + chain.request().url());
    ...
    private void logForRequest(Request request, Connection connection) throws IOException {
        boolean logBody = (level == Level.BODY || level == Level.BASIC);
        boolean logHeaders = (level == Level.BODY || level == Level.HEADERS || level == Level.BASIC);
    ...
    private String bodyToString(Request request) {
        try {
            ...
            if (requestBody != null) {
                ...
                if (charset != null) {
//                    Logger.json(URLDecoder.decode(buffer.readString(charset), UTF8.name()));
